...
async def start(client: Client, msg: Message):
    ...
    await start_message.edit_text(
        Data.START.format(msg.from_user.mention) +
        "Checking status Ok... Command Nhi Bataunga **Bot Made BY 𓆰𝐑𝐀𝐍𝐀 𝐉𝐈𝐈 𓆪**🔍\n\n"
        "Progress:[🟩🟩🟩🟩🟩🟩🟩🟩🟩] 100%\n\n"
    )
...
@bot.on_message(filters.command(["RANAJII25", "RANA25"]) )
async def txt_handler(bot: Client, m: Message):
    await m.delete()
    
    editable = await m.reply_text(f"**🔹Hi I am Poweful RANA JII TXT Downloader📥 Bot.**\n🔹**Send me the TXT file and wait.**")
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:  
                ...
                cc = f'**🎞️ VID_ID: {str(count).zfill(3)}.\n\nTitle: {name1} 𝐑𝐀𝐍𝐀 𝐉𝐈𝐈 {res}.mkv\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n**━━━━━✦📖𓆰𝐑𝐀𝐍𝐀 𝐉𝐈𝐈📖✦━━━━━**'
                cc1 = f'**📁 PDF_ID: {str(count).zfill(3)}.\n\nTitle: {name1} 𝐑𝐀𝐍𝐀 𝐉𝐈𝐈.pdf\n\n📚 Batch Name: {b_name}\n\n📥 Extracted By : {CR}\n\n**━━━━━✦📖𓆰𝐑𝐀𝐍𝐀 𝐉𝐈𝐈 📖✦━━━━━**'
